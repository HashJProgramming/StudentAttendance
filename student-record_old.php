...
<body>
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="instudent-record.phpstudent-record.phpdex.php"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
...
//                                echo "<td class='text-center'>$i <i class='fa fa-check text-success'></i></td>";

                            } else {
//                                echo "<td class='text-center'>$i <i class='fa fa-close text-danger'></i></td>";
